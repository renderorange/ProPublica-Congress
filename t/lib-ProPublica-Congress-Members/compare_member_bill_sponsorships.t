...
HAPPY_PATH: {
    ...
    my $comparison = $members_obj->compare_member_bill_sponsorships( member_id_1 => 'ABC123', member_id_2 => 'ABC124', congress => 102, chamber => 'house' );
...
EXCEPTIONS: {
    ...
    foreach my $arg ( qw{ member_id_1 member_id_2 } ) {
        ...
        dies_ok { $members_obj->compare_member_bill_sponsorships(
            %args 
